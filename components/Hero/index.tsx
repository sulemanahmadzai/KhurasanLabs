...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <div className="relative container mt-16 px-4 w-full">
                <h1 className="text-3xl md:text-[128px] md:leading-[0.9] font-semibold tracking-tight bg-white bg-[radial-gradient(100%_100%_at_top_left,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center w-full" style={{ letterSpacing: '-0.02em' }}>KhurasanLabs</h1>
                <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
                    Transforming ideas into exceptional digital experiences. We craft AI-powered
                    solutions, stunning web apps, and intuitive user experiences.
                </p>
