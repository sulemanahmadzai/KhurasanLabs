...
const testimonials = [
    {
        text: "\"The team delivered an exceptional web application that exceeded all our expectations\"",
        name: "Sophia Perez",
        title: "Director @ Quantum",
        avatarImg: avatar1,
    },
    {
        text: "\"Their AI integration transformed our business operations and user experience completely\"",
        name: "Jamie Lee",
        title: "Founder @ Pulse",
        avatarImg: avatar2,
    },
    {
        text: "\"The UI/UX design is stunning and intuitive. Our users love the new interface\"",
        name: "Alisa Hester",
        title: "Product @ Innovate",
        avatarImg: avatar3,
    },
    {
        text: "\"From concept to launch, they built our mobile app flawlessly. Highly recommended\"",
        name: "Alec Whitten",
        ...
        <section className="py-20 md:py-24">
            <div className="container">
                ...
                <p className="text-white/70 text-lg md:text-xl text-center mt-5 tracking-tight max-w-sm mx-auto">
                    We&apos;ve helped countless clients transform their digital presence with innovative solutions.
                </p>
