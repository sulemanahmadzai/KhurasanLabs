    ...
    return (
        <section className="py-20 md:py-24">
            <div className="container">
                <h2 className="text-5xl md:text-6xl font-medium text-center tracking-tighter">Full-Stack Digital Solutions</h2>
                <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">
                    From innovative startups to established enterprises, we deliver cutting-edge
                    web applications, beautiful interfaces, and intelligent AI solutions.
                </p>
