  ...
  const values = [
    {
      title: "Innovation",
      description:
        "We push boundaries and explore new possibilities, always staying ahead of the curve in technology and design.",
      icon: "💡",
    ...
    },
    {
      title: "Collaboration",
      description:
        "We believe in working closely with our clients, fostering partnerships that lead to exceptional outcomes.",
      icon: "🤝",
    ...
    },
    {
      title: "Integrity",
      description:
        "Transparency, honesty, and ethical practices guide everything we do, building trust with every interaction.",
      icon: "✨",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-white/80 leading-relaxed max-w-3xl mx-auto">
                  Rahnor Labs is a forward-thinking digital agency born from a
                  passion for innovation and excellence. We combine technical
                  expertise with creative vision to transform ideas into
                  reality, helping businesses thrive in the digital landscape.
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className="text-white/80 leading-relaxed">
                    ...
                    technology and exceptional design, RAHNOR LABS has grown
                    into a trusted partner for businesses seeking to make their
                    mark in the digital world. We believe that every project is
                ...
                >
                  ...
                  <p className="text-white/80 leading-relaxed">
                    We take a collaborative, client-centric approach to every
                    project. By understanding your unique needs and goals, we
                    craft solutions that not only meet but exceed expectations.
                    Our agile methodology ensures flexibility and continuous
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                >
                  ...
                  <p className="text-lg text-white/80 leading-relaxed">
                    At RahnorLabs, we believe in the power of technology to
                    transform businesses and improve lives. Our mission is to
                    deliver innovative, high-quality digital solutions that help
                    our clients achieve their goals and exceed their
                    expectations. We&apos;re committed to staying at the
                    forefront of technology trends and continuously evolving our
                ...
                >
                  ...
                  <p className="text-lg text-white/80 leading-relaxed">
                    To be the leading digital agency that businesses trust to
                    bring their boldest ideas to life. We envision a future
                    where technology seamlessly integrates with human
                    creativity, creating experiences that inspire, engage, and
                    drive meaningful change. Through innovation and excellence,
